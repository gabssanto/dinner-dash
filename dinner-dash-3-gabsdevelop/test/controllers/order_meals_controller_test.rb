...
class OrderMealsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_meal" do
    assert_difference('OrderMeal.count') do
      post order_meals_url, params: { order_meal: { Meal_id: @order_meal.Meal_id, Order_id: @order_meal.Order_id, integer: @order_meal.integer, quantity: @order_meal.quantity } }
    end
  ...
  test "should update order_meal" do
    patch order_meal_url(@order_meal), params: { order_meal: { Meal_id: @order_meal.Meal_id, Order_id: @order_meal.Order_id, integer: @order_meal.integer, quantity: @order_meal.quantity } }
