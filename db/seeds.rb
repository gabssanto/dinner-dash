...
Meal.create(name: 'Molho de Iogurte', description: 'Possui azeite, iogurte, alho, limão, hortelã e salsinha.', price: '5', image: '/images/Molho de Iogurte.jpg', avaible: '1', MealCategory_id: '2'  )
Meal.create(name: 'Molho de Mostarda', description: 'Possui mostarda, maionese, azeite, limão e alho em pó.', price: '5', image: '/images/Molho de Mostarda.jpg', avaible: '1', MealCategory_id: '2'  )
Meal.create(name: 'Molho Vinagrete', description: 'Possui cebola, tomate, limão, pimenta calabresa e sal.', price: '5', image: '/images/Molho Vinagrete.jpg', avaible: '1', MealCategory_id: '2'  )
Meal.create(name: 'Molho de Coentro', description: 'Possui coentro, iogurte, limão, alho, azeite e vinagre.', price: '5', image: '/images/Molho de Coentro.jpg', avaible: '1', MealCategory_id: '2'  )
Meal.create(name: 'Strogonoff de Frango', description: 'Possui frango, alho, cebola, azeite, creme de leite e mostarda.', price: '18', image: '/images/Strogonoff de Frango.jpg', avaible: '1', MealCategory_id: '3'  )
Meal.create(name: 'Filé ao Molho Madeira', description: 'Possui filé mignon, vinho tinto, alho e cogumelos.', price: '18', image: '/images/Filé ao Molho Madeira.jpg', avaible: '1', MealCategory_id: '3'  )
Meal.create(name: 'Parmegiana de Carne', description: 'Possui alcatra, alho, cebola, molho de tomate, mussarela.', price: '18', image: '/images/Parmegiana de Carne.jpg', avaible: '1', MealCategory_id: '3'  )
Meal.create(name: 'Parmegiana de Frango', description: 'Possui frango, alho, cebola, molho de tomate, queijo mussarela.', price: '18', image: '/images/Parmegiana de Frango.jpg', avaible: '1', MealCategory_id: '3'  )
Meal.create(name: 'Purê de Batatas', description: 'Possui batata, manteiga, leite, nós moscada e creme de leite', price: '12', image: '/images/Purê de Batatas.jpg', avaible: '1', MealCategory_id: '4'  )
Meal.create(name: 'Batata Frita', description: 'Possui batata, orégano e sal, além de pouco óleo', price: '12', image: '/images/Batata Frita.jpg', avaible: '1', MealCategory_id: '4'  )
Meal.create(name: 'Farofa de Couve', description: 'Possui couve, cebola, alho, azeite e farinha de mandioca', price: '12', image: '/images/Farofa de Couve.jpg', avaible: '1', MealCategory_id: '4'  )
Meal.create(name: 'Farofa de Banana', description: 'Possui banana, bacon, passas, azeite, salsinha e farinha', price: '12', image: '/images/Farofa de Banana.jpg', avaible: '1', MealCategory_id: '4'  )
